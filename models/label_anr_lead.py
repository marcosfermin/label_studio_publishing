...
class LabelAnrLead(models.Model):
    ...
    estimated_deal_value = fields.Monetary(string='Estimated Deal Value', currency_field='currency_id')
    estimated_advance = fields.Monetary(string='Estimated Advance', currency_field='currency_id')
